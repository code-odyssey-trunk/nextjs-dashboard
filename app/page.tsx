      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        />
          <p className={`${lusitana.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Welcome to NexTy.</strong> A modern web application built with Next.js, TypeScript, Tailwind CSS, and PostgreSQL. It features a dynamic dashboard, responsive design, and invoice management with creation, editing, and deletion capabilities.
          </p>
          <Link
            href="/login"
